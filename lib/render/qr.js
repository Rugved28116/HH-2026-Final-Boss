...
// The fallback is the project's canonical vercel.app URL (project name kept
// ≤12 chars precisely so this stays a version-2 symbol). Not hhgoa.com — we
// don't own that domain, and a QR pointing at someone else's site is worse
// than no QR.
export const QR_TARGET_URL =
  process.env.NEXT_PUBLIC_SITE_URL || 'https://hhgoa2026.vercel.app/';
